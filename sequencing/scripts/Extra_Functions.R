...
# initial setup
raw_read_setup <- function(packages, raw_path, filt_path, plot_path = NULL, output_path = NULL, progress_path = NULL, ref_fasta = NULL, meta_data = NULL, fwd_error = NULL, rev_error = NULL, run_filter){
